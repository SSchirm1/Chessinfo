...
namespace Chessinfo.Controllers
{
    public class TitlesController : Controller
    {
        ...
        public TitlesController(ChessinfoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,TitleCode")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,TitleCode")] Title title)
        {
            if (id != title.Id)
            {
                return NotFound();
